...
<p class="language-note"><strong>Note on Gossamer:</strong> another young, pre-1.0 language. It is measured on its LLVM ahead-of-time back-end (<code>gos build --release</code>), the production target.</p>
